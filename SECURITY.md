...
Please submit your findings as security advisories under the "Security" tab in the relevant GitHub repository. Alternatively, you may send the details of your findings to [security@fortishield.github.io](mailto:security@fortishield.github.io).
...
- Exceptions: In order to preserve the security of the Fortishield community at large, we might extend the disclosure period to allow users to patch their deployments.
...
If you have any questions about this Security Policy, please contact us at [security@fortishield.github.io](mailto:security@fortishield.github.io).
