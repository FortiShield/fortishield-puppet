...
# Fortishield-Agent configuration parameters
class fortishield::params_agent {
  $agent_package_version = '5.0.0'
  $agent_package_revision = '1'
  $agent_service_ensure = 'running'
  $agent_msi_download_location = 'https://packages.fortishield.github.io/4.x/windows'
  ...
  $fortishield_agent_cert = undef
  $fortishield_agent_key = undef
  $fortishield_agent_cert_path = undef
  $fortishield_agent_key_path = undef
  $agent_auth_password = undef
  $fortishield_manager_root_ca_pem = undef
  $fortishield_manager_root_ca_pem_path = undef
  ...
  $ossec_conf_template = 'fortishield/fortishield_agent.conf.erb'
  ...
  $ossec_auth = 'fortishield/fragments/_auth.erb'
  $ossec_cluster = 'fortishield/fragments/_cluster.erb'
  $ossec_active_response_template = 'fortishield/fragments/_activeresponse.erb'

  # ossec.conf blocks

  ## Server block configuration
  $fortishield_register_endpoint = undef
  $fortishield_reporting_endpoint = undef
  $ossec_port = '1514'
  $ossec_protocol = 'tcp'
  $fortishield_max_retries = '5'
  $fortishield_retry_interval = '5'
  ...
  $fortishield_enrollment_enabled                        = undef
  $fortishield_enrollment_manager_address                = undef
  $fortishield_enrollment_port                           = undef
  $fortishield_enrollment_agent_name                     = undef
  $fortishield_enrollment_groups                         = undef
  $fortishield_enrollment_agent_address                  = undef
  $fortishield_enrollment_ssl_cipher                     = undef
  $fortishield_enrollment_server_ca_path                 = undef
  $fortishield_enrollment_agent_cert_path                = undef
  $fortishield_enrollment_agent_key_path                 = undef
  $fortishield_enrollment_auth_pass                      = undef
  $fortishield_enrollment_auth_pass_path                 = $authd_pass_file
  $fortishield_enrollment_auto_method                    = undef
  $fortishield_delay_after_enrollment                    = undef
  $fortishield_enrollment_use_source_ip                  = undef

  # Other required to define variables
  $manage_firewall = false
  $selinux = false
  $configure_labels = false
  $ossec_labels_template = 'fortishield/fragments/_labels.erb'
  $ossec_labels = []
  ...
  case $::kernel {
    'Linux': {
      $agent_package_name = 'fortishield-agent'
      $agent_service_name = 'fortishield-agent'
    ...
    'windows': {
      ...
      $agent_package_name = 'Fortishield Agent'
      $agent_service_name = 'FortishieldSvc'
      $service_has_status = true
      $ossec_service_provider = undef
