...
mkdir kitchen/modules/fortishield
echo `ls -lah ./`
echo `ls -lah kitchen/modules`
cp -r `ls -A | grep -v "kitchen"` kitchen/modules/fortishield/
echo `ls -lah kitchen/modules/fortishield`
...
#
#echo "Getting Fortishield managers IPs to the agents"
...
#
#echo "fortishield-manager IP"
#echo $manager_ip
#
#echo "Assigning Fortishield managers IPs to the corresponding agents."
